...
#ifndef RTW_HEADER_real_pi_pos_mesure_h_
#define RTW_HEADER_real_pi_pos_mesure_h_
#include <string.h>
#ifndef real_pi_pos_mesure_COMMON_INCLUDES_
# define real_pi_pos_mesure_COMMON_INCLUDES_
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* real_pi_pos_mesure_COMMON_INCLUDES_ */

#include "real_pi_pos_mesure_types.h"
...
#define real_pi_pos_mesure_rtModel     RT_MODEL_real_pi_pos_mesure_T
...
#define rtB                            real_pi_pos_mesure_B
#define BlockIO                        B_real_pi_pos_mesure_T
#define rtX                            real_pi_pos_mesure_X
#define ContinuousStates               X_real_pi_pos_mesure_T
#define rtXdot                         real_pi_pos_mesure_XDot
#define StateDerivatives               XDot_real_pi_pos_mesure_T
#define tXdis                          real_pi_pos_mesure_XDis
#define StateDisabled                  XDis_real_pi_pos_mesure_T
#define rtP                            real_pi_pos_mesure_P
#define Parameters                     P_real_pi_pos_mesure_T
#define rtDWork                        real_pi_pos_mesure_DW
#define D_Work                         DW_real_pi_pos_mesure_T
...
struct tag_RTM_real_pi_pos_mesure_T {
  const char_T *path;
...
extern P_real_pi_pos_mesure_T real_pi_pos_mesure_P;

/* Block signals (default storage) */
extern B_real_pi_pos_mesure_T real_pi_pos_mesure_B;

/* Continuous states (default storage) */
extern X_real_pi_pos_mesure_T real_pi_pos_mesure_X;

/* Block states (default storage) */
extern DW_real_pi_pos_mesure_T real_pi_pos_mesure_DW;

/* Model entry point functions */
extern void real_pi_pos_mesure_initialize(void);
extern void real_pi_pos_mesure_output(void);
extern void real_pi_pos_mesure_update(void);
extern void real_pi_pos_mesure_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern real_pi_pos_mesure_rtModel *real_pi_pos_mesure(void);
...
extern RT_MODEL_real_pi_pos_mesure_T *const real_pi_pos_mesure_M;
