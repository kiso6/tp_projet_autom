...
MODEL                := real_prop
MODULES              := real_prop_data.c real_prop_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := real_prop.mk
...
TID01EQ              := 0
NCSTATES             := 0
BUILDARGS            :=  EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 TMW_EXTMODE_TESTING=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DTGTCONN -DEXT_MODE -DON_TARGET_WAIT_FOR_START=1 -DTID01EQ=0"
MULTITASKING         := 0
EXT_MODE             := 1
EXTMODE_TRANSPORT    := 0
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := real_prop_ref.rsp
...
# additional includes
REQ_INCLUDES += ;U:/Bureau/4AE-SE/mini_projet_autom/tp_projet_autom/Matlab;U:/Bureau/4AE-SE/mini_projet_autom/tp_projet_autom/Matlab/real_prop_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
