...
MODEL                := SYSTEME_CORRIGE_MODELE_ETAT_REEL
MODULES              := SYSTEME_CORRIGE_MODELE_ETAT_REEL_data.c SYSTEME_CORRIGE_MODELE_ETAT_REEL_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := SYSTEME_CORRIGE_MODELE_ETAT_REEL.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := SYSTEME_CORRIGE_MODELE_ETAT_REEL_ref.rsp
...
# additional includes
REQ_INCLUDES += ;U:/Bureau/4AE-SE/mini_projet_autom/tp_projet_autom/Matlab;U:/Bureau/4AE-SE/mini_projet_autom/tp_projet_autom/Matlab/SYSTEME_CORRIGE_MODELE_ETAT_REEL_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
