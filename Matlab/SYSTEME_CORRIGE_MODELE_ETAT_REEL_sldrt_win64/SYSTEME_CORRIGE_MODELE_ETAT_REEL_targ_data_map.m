  ...
  ;%***********************
    ...
    ;%
    ;% Auto data (SYSTEME_CORRIGE_MODELE_ETAT_REEL_P)
    ;%
      section.nData     = 17;
      section.data(17)  = dumData; %prealloc
      
	  ;% SYSTEME_CORRIGE_MODELE_ETAT_REEL_P.K
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% SYSTEME_CORRIGE_MODELE_ETAT_REEL_P.Ki
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 2;
	
	  ;% SYSTEME_CORRIGE_MODELE_ETAT_REEL_P.Kp
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 3;
	
	  ;% SYSTEME_CORRIGE_MODELE_ETAT_REEL_P.PIDController_D
	  ...
	  ;% SYSTEME_CORRIGE_MODELE_ETAT_REEL_P.AnalogInput1_MaxMissedTicks
	  section.data(10).logicalSrcIdx = 9;
	  section.data(10).dtTransOffset = 10;
	
	  ;% SYSTEME_CORRIGE_MODELE_ETAT_REEL_P.AnalogInput_MaxMissedTicks
	  section.data(11).logicalSrcIdx = 10;
	  section.data(11).dtTransOffset = 11;
	
	  ;% SYSTEME_CORRIGE_MODELE_ETAT_REEL_P.AnalogOutput_MaxMissedTicks
	  ...
	  ;% SYSTEME_CORRIGE_MODELE_ETAT_REEL_P.AnalogInput1_YieldWhenWaiting
	  section.data(15).logicalSrcIdx = 14;
	  section.data(15).dtTransOffset = 15;
	
	  ;% SYSTEME_CORRIGE_MODELE_ETAT_REEL_P.AnalogInput_YieldWhenWaiting
	  section.data(16).logicalSrcIdx = 15;
	  section.data(16).dtTransOffset = 16;
	
	  ;% SYSTEME_CORRIGE_MODELE_ETAT_REEL_P.AnalogOutput_YieldWhenWaiting
	  ...
	  ;% SYSTEME_CORRIGE_MODELE_ETAT_REEL_P.AnalogInput1_VoltRange
	  section.data(7).logicalSrcIdx = 23;
	  section.data(7).dtTransOffset = 6;
	
	  ;% SYSTEME_CORRIGE_MODELE_ETAT_REEL_P.AnalogInput_VoltRange
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (SYSTEME_CORRIGE_MODELE_ETAT_REEL_DW)
    ;%
      section.nData     = 7;
      section.data(7)  = dumData; %prealloc
      
	  ;% SYSTEME_CORRIGE_MODELE_ETAT_REEL_DW.AnalogInput1_PWORK
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% SYSTEME_CORRIGE_MODELE_ETAT_REEL_DW.AnalogInput_PWORK
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	
	  ;% SYSTEME_CORRIGE_MODELE_ETAT_REEL_DW.AnalogOutput_PWORK
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
	
	  ;% SYSTEME_CORRIGE_MODELE_ETAT_REEL_DW.Scope1_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 3;
	
	  ;% SYSTEME_CORRIGE_MODELE_ETAT_REEL_DW.TAQSigLogging_InsertedFor_AnalogInput1_at_outport_0_PWORK.AQHandles
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 6;
	
	  ;% SYSTEME_CORRIGE_MODELE_ETAT_REEL_DW.TAQSigLogging_InsertedFor_AnalogInput_at_outport_0_PWORK.AQHandles
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 7;
	
	  ;% SYSTEME_CORRIGE_MODELE_ETAT_REEL_DW.TAQSigLogging_InsertedFor_Step_at_outport_0_PWORK.AQHandles
	  section.data(7).logicalSrcIdx = 6;
