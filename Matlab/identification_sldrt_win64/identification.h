...
#define identification_rtModel         RT_MODEL_identification_T
...
#define rtB                            identification_B
#define BlockIO                        B_identification_T
#define rtP                            identification_P
#define Parameters                     P_identification_T
#define rtDWork                        identification_DW
#define D_Work                         DW_identification_T

/* Parameters (default storage) */
struct P_identification_T_ {
...
struct tag_RTM_identification_T {
  const char_T *path;
...
extern P_identification_T identification_P;

/* Block signals (default storage) */
extern B_identification_T identification_B;

/* Block states (default storage) */
extern DW_identification_T identification_DW;

/* Model entry point functions */
extern void identification_initialize(void);
extern void identification_output(void);
extern void identification_update(void);
extern void identification_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern identification_rtModel *identification(void);
...
extern RT_MODEL_identification_T *const identification_M;
 ...
 *
 * '<Root>' : 'identification'
 * '<S1>'   : 'identification/Chirp Signal'
 */
